...
export default function ProfileTab() {
  return (
    <SafeAreaView style={s.safe}>
      <View style={s.header}>
        <View style={s.avatar}><Text style={s.avatarText}>PG</Text></View>
        <Text style={s.name}>Priya Govender</Text>
        <Text style={s.phone}>+27 82 123 4567</Text>
      ...
      <ScrollView style={s.body}>
        <View style={s.pointsBox}>
          ...
          <View style={s.pointsBar}><View style={[s.pointsFill, { width: '68%' }]} /></View>
...
const s = StyleSheet.create({
  ...
  name:       { fontSize: 20, fontWeight: '300', color: '#fff', marginBottom: 2 },
  phone:      { fontSize: 13, color: 'rgba(255,255,255,0.5)', marginBottom: 10 },
