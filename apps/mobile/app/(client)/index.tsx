...
const SERVICES = [
  { id: 'plumbing',   label: 'Plumbing',   price: 'From R350', emoji: '💧', bg: '#DBEAFE', iconColor: '#1D4ED8' },
  { id: 'electrical', label: 'Electrical', price: 'From R400', emoji: '⚡', bg: '#FEF3C7', iconColor: '#D97706' },
  { id: 'cleaning',   label: 'Cleaning',   price: 'From R250', emoji: '🧹', bg: '#D1FAE5', iconColor: '#065F46' },
  { id: 'hvac',       label: 'AC & HVAC',  price: 'From R500', emoji: '❄️', bg: '#EDE9FE', iconColor: '#7C3AED' },
  { id: 'gas',        label: 'Gas',        price: 'From R450', emoji: '🔥', bg: '#FEE2E2', iconColor: '#DC2626' },
  { id: 'handyman',   label: 'Handyman',   price: 'From R300', emoji: '🔧', bg: '#FEF3C7', iconColor: '#92400E' },
]
  ...
  return (
    <SafeAreaView style={s.safe}>
      ...
      <View style={s.header}>
        ...
        <Text style={s.name}>Priya Govender</Text>
        <View style={s.badge}>
